...
real * 16 :: m_1,m_2,M,mu,S_1,S_2,S_Kerr,a,chi_Kerr,nu,K,omega_1,omega_2,alpha,beta,gamma,g(5)
...
real * 16 :: Carter
integer :: i
!为了计算角动量选取近心点和远心点作为特殊点，定义如下参量来表征这两个特殊点的物理量
...
function Metric(coordinates)
    ...
    real * 16 :: m_1,m_2,M,mu,nu,S_1,S_2,S_Kerr,a,chi_Kerr,K,omega_1,omega_2,Delta_0,Delta_1,Delta_2,Delta_3,Delta_4
...
function D_Parameter(coordinates,Momentum)
  ...
  !dg_tt/dth
  D_Metric(2) =  a**2*Sin(2*theta)*(varpi_square*Delta_t-varpi_square**2)/(Delta_t*Sigma**2)
  !dg_rr/dth
  ...
  D_Parameter(9) = D_Metric(7) - (2*g(5)*gtt*D_Metric(9)-g(5)**2*D_Metric(1))/gtt**2
  !dalpha_dth
  ...
  D_Parameter(10) = D_Metric(8) - (2*gtphi*gtt*D_Metric(10)-g(5)**2*D_Metric(2))/gtt**2
...
function P_R_Dot(coordinates,Momentum,Derivative_of_parameters)
  implicit none
  COMMON M,mu,nu,S_1,S_2,S_Kerr,a,chi_Kerr,K,omega_1,omega_2,Delta_0,Delta_1,Delta_2,Delta_3,Delta_4
  real * 16, INTENT(IN) :: coordinates(3),Momentum(3),Derivative_of_parameters(10)
  real * 16 :: m_1,m_2,M,mu,nu,S_1,S_2,S_Kerr,a,chi_Kerr,K,omega_1,omega_2,Delta_0,Delta_1,Delta_2,Delta_3,Delta_4
