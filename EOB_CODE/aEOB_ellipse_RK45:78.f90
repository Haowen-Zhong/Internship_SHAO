...
Subroutine Evolution_RK45(h,coordinates,Momentum,t,t_f)
  ...
  do while (t .le. t_f)
    ...
    do i = 1,5
      X1(i) = X(i) + h*(439_16/216_16*Y0(i)-8_16*Y1(i)+3680_16/513_16*Y2(i)-845_16/4101_16*Y3(i))
    end do
    call Differential_Eq(X1,Y4)

    do i = 1,5
      X1(i) = X(i) + h*(-8_16/27_16*Y0(i)+2_16*Y1(i)-3544_16/2565_16*Y2(i)+1859_16/4101_16*Y3(i)-11_16/40_16*Y4(i))
    end do
    call Differential_Eq(X1,Y5)

    do i = 1,5
      X(i) = X(i) + h*(16_16/135_16*Y0(i)+6656_16/12858_16*Y2(i) + 28561_16/56430_16*Y3(i) -&
